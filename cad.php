				...
				<form id="cadastroImpressao" class="form" action="" method="post">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="atividadeRadio" id="atividadeRadio" value="atividade1">
								<label class="form-check-label" for="inlineRadio2">Atividade Avaliativa</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="atividadeRadio" id="atividadeRadio" value="atividade2">
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label>Lado</label><br>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="lado" id="lado" value="lado1">
								<label class="form-check-label" for="inlineRadio2">Frente</label>
							</div>
							<div class="form-check form-check-inline">
								<input class="form-check-input" type="radio" name="lado" id="lado" value="lado2">
					...
					<div class="form-row">
						<div class="form-group col-md-12">
							<label>Arquivo</label>
							<input type="file" class="form-control-file" id="ArquivoFile" name="ArquivoFile" aria-describedby="fileHelp">
						</div>
					</div>
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
<script src="scriptImpressao.js"></script> <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
<script src="scriptImpressao.js"></script>
</body>
</html>